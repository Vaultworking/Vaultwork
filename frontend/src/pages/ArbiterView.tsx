...
import { Shield, Scale, Gavel, AlertTriangle, CheckCircle, Clock, ArrowLeft, Search, Filter, Users, DollarSign, Activity, Info } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-xl shadow-purple-500/25">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-xl mx-auto">
              Connect your Freighter wallet to access the arbiter dashboard and resolve disputes
            </p>
