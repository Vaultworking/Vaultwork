...
import { CheckCircle, AlertTriangle, Clock, Shield, Loader2, ArrowLeft, DollarSign, Users, Calendar, FileText, Send, AlertCircle, Info, Lock, ArrowRight } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 md:p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Connect Wallet to View Project Details</h2>
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-xl mx-auto">
              You need to connect your Freighter wallet to view project details, manage milestones, and interact with escrow contracts on the Stellar network.
            </p>
          ...
          {/* Preview Section */}
          <div className="mt-8">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">What you can do with project details:</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                ...
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">View Milestones</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">Track project progress and milestone completion status</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mb-4">
                  <DollarSign className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                </div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Manage Payments</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">Approve milestones and release payments securely</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                <div className="w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mb-4">
                  <Users className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                </div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">View Participants</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">See client, freelancer, and arbiter information</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                <div className="w-10 h-10 bg-amber-100 dark:bg-amber-900/30 rounded-lg flex items-center justify-center mb-4">
                  <Clock className="w-5 h-5 text-amber-600 dark:text-amber-400" />
                </div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Review Deadlines</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">Check review window countdowns for delivered milestones</p>
              </div>
            </div>
          </div>
        </div>
