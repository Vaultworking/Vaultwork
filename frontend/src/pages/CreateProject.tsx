...
import { Plus, Trash2, Loader2, ArrowLeft, Info, DollarSign, Clock, Shield, CheckCircle, Users, Lock } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 md:p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Connect Wallet to Create Projects</h2>
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-xl mx-auto">
              You need to connect your Freighter wallet to create milestone escrow contracts and manage payments on the Stellar network.
            </p>
          ...
          {/* Preview Section */}
          <div className="mt-8">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">What you'll need to create a project:</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                ...
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Freelancer Address</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">The Stellar address of the freelancer you're working with</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mb-4">
                  <Shield className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                </div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Arbiter Address</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">A trusted third party who can resolve disputes if needed</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                ...
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Milestones</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">Define project milestones with amounts and descriptions</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
                <div className="w-10 h-10 bg-amber-100 dark:bg-amber-900/30 rounded-lg flex items-center justify-center mb-4">
                  <Clock className="w-5 h-5 text-amber-600 dark:text-amber-400" />
                </div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Review Window</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">Set how long you have to review each milestone before auto-release</p>
              </div>
            </div>
          </div>
        </div>
